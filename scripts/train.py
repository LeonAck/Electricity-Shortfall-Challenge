...
from scripts.cross_validation_and_tuning import get_split_type, get_search_class_and_params
...
def train_with_hyperparameter_tuning(model_config: Dict[str, Any], config: Dict[str, Any], 
    ...
    if not param_grid or len(param_grid) == 0:
        ...
        return cv_rmse, model_config['params']
...
def choose_best_model(output_dir: str, train_df, config: Dict[str, Any]) -> BestModelResult:
    """
